...
$$
[0, 3), [3, 4), [4, 5), [5, 6), [6, 7), [7, 8), [8, 9), [9, 10), [10, 12), [12, 14), [14, 15), [15, 18), [18, 24), [24, 30), [30, 36), [36, 42), [42, 48), [48, 60), [60, 73), [73, 91), [91, 115), [115, 133), [133, 169), [169, \infty)
$$
...
我们使用刑期区间映射将刑期预测问题转化为了多分类问题，在Kaggle平台取得了 $0.20300$ 的分数。

| 方法 | 零样本学习 | 全部预测为 0 | 预测为该罪名最常见的刑期 | 分类器 |
| :--: | :--: | :--: | :--: | :--: |
| 得分 | 0.05777（本地） | 0.1703 | 0.16785 | 0.20300 |
