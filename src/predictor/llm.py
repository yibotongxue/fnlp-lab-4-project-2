...
class LLMPredictor(BasePredictor):
    """LLM predictor that uses an LLM to generate responses based on prompts."""
...
"""
    ...
    def predict_judgment(self, fact: str, defendants: list[str]) -> list[OutcomeDict]:
        ...
        """
        prompt = self.build_prompt(fact, defendants)["prompt"]
    ...
    def build_prompt(self, fact: str, defendants: list[str]) -> dict:
        """
        Build a prompt for the LLM based on the provided fact and defendants.
        ...
        Returns:
            dict: The dictionary contains constructed prompt string.
        """
